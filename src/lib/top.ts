...
/**
 * The 5 most-analyzed episodes of the last 7 days, ranked by DISTINCT IPs
 * per video, so one viewer re-submitting a video (free cache hits included)
 * counts once and can't game the leaderboard.
 */
export async function getTop(): Promise<TopItem[]> {
